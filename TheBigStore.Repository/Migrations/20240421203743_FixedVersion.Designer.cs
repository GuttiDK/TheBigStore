...
namespace TheBigStore.Repository.Migrations
{
    ...
    [Migration("20240421203743_FixedVersion")]
    partial class FixedVersion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TheBigStore.Repository.Models.Customer", b =>
                {
                    ...
                    b.HasOne("TheBigStore.Repository.Models.User", "User")
                        .WithOne("Customer")
                        .HasForeignKey("TheBigStore.Repository.Models.Customer", "UserId")
